...
217. 下一步建议继续 Engine public header 低风险 implementation detail audit，或回到 callback/bootstrapper include surface audit。renderer 侧只推进通用 backend contract，不扩张 PBR pass。
