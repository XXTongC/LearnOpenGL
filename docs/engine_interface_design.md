...
259. 下一步建议继续 editor/runtime public header include audit，优先处理 DebugControllerPanel context header 或 RuntimeEditorLifecycle headers；renderer 侧只推进通用 backend/runtime contract，不扩张 PBR pass。
