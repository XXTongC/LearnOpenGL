...
### Current Round: Shadow Resource Binder Header Boundary Cleanup

Parent mode: implementation owner.

Parent write scope:

- `renderer/ShadowResourceBinder.h`
- `renderer/ShadowResourceBinder.cpp`
...
- Global `Camera` forward declaration, GLframework shader/light forward declarations, and explicit implementation includes remain parent-reviewed.
...
Round: 2026-06-01 Shadow Resource Binder Header Boundary Cleanup.
...
- Current local implementation target for this slice: remove complete camera, shader, directional light, and point light headers from `ShadowResourceBinder.h`; keep CSM shadow, point shadow, camera, shader, light field access, and texture dependencies in `ShadowResourceBinder.cpp`.
...
- No new sidecar subagent is started in this round; the Shadow Resource Binder Header Boundary Cleanup is parent-owned and has no delegated write scope.
- No active sidecar remains open in this round.
- Parent-owned write scope for this round: `renderer/ShadowResourceBinder.h`, `renderer/ShadowResourceBinder.cpp`, docs, and logs.
