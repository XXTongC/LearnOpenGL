...
### Current Round: PBR Material Binder Header Boundary Cleanup

Parent mode: implementation owner.

Parent write scope:

- `renderer/PBRMaterialBinder.h`
- `renderer/PBRMaterialBinder.cpp`
...
Round: 2026-06-01 PBR Material Binder Header Boundary Cleanup.
...
- Current local implementation target for this slice: remove complete shader, PBR material, mesh, and material binding context headers from `PBRMaterialBinder.h`; keep PBR material dispatch and resource binder dependencies in `PBRMaterialBinder.cpp`.
...
- No new sidecar subagent is started in this round; the PBR Material Binder Header Boundary Cleanup is parent-owned and has no delegated write scope.
- No active sidecar remains open in this round.
- Parent-owned write scope for this round: `renderer/PBRMaterialBinder.h`, `renderer/PBRMaterialBinder.cpp`, docs, and logs.
