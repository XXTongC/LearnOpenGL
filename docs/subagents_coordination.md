...
### Current Round: Runtime Frame Pipeline Context Header Boundary Cleanup

Parent mode: implementation owner.

Parent write scope:

- `application/RuntimeFramePipeline.h`
- `application/RuntimeFramePipeline.cpp`
- `application/RuntimeFramePasses.h`
...
- Runtime frame pipeline/pass context include boundary and runtime backend adapter compile coverage remain parent-reviewed.
...
Round: 2026-05-31 Runtime Frame Pipeline Context Header Boundary Cleanup.
...
- Current local implementation target for this slice: remove complete `AppRuntimeContext.h` propagation from `RuntimeFramePipeline.h` and `RuntimeFramePasses.h`, keep only forward declarations in public frame pipeline/pass headers, and make implementations include complete context/config headers where they read fields.
...
- No new sidecar subagent is started in this round; the Runtime Frame Pipeline Context Header Boundary Cleanup is parent-owned and has no delegated write scope.
- No active sidecar remains open in this round.
- Parent-owned write scope for this round: `application/RuntimeFramePipeline.h`, `application/RuntimeFramePipeline.cpp`, `application/RuntimeFramePasses.h`, `application/RuntimeFramePasses.cpp`, `application/RuntimeFramePassRegistry.cpp`, docs, and logs.
