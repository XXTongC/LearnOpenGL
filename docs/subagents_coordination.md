...
### Current Round: PBR IBL Resource Binder Header Boundary Cleanup

Parent mode: implementation owner.

Parent write scope:

- `renderer/PBRIBLResourceBinder.h`
...
- Shader, PBR material, and environment target forward declarations plus explicit implementation includes remain parent-reviewed.
...
Round: 2026-06-01 PBR IBL Resource Binder Header Boundary Cleanup.
...
- Current local implementation target for this slice: remove complete shader and PBR material headers from `PBRIBLResourceBinder.h`; keep IBL material flags, IBL float slots, environment targets, shader, and texture dependencies in `PBRIBLResourceBinder.cpp`.
...
- No new sidecar subagent is started in this round; the PBR IBL Resource Binder Header Boundary Cleanup is parent-owned and has no delegated write scope.
- No active sidecar remains open in this round.
- Parent-owned write scope for this round: `renderer/PBRIBLResourceBinder.h`, `renderer/PBRIBLResourceBinder.cpp`, docs, and logs.
