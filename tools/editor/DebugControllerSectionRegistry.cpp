...
namespace GL_EDITOR
{
	bool DebugControllerSectionRegistry::registerSection(DebugControllerSection section)
	{
	...
	std::size_t DebugControllerSectionRegistry::drawAll(const DebugControllerContext& context) const
	{
